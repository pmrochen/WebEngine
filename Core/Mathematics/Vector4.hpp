...
struct Vector4
{
	...
	Vector4& setMinimum(const Vector4& v1, const Vector4& v2) noexcept;
	Vector4& setMaximum(const Vector4& v1, const Vector4& v2) noexcept;
...
template<typename T>
inline Vector4<T> minimum(const Vector4<T>& v1, const Vector4<T>& v2) noexcept
{
	return Vector4<T>(std::min(v1.x, v2.x), std::min(v1.y, v2.y), std::min(v1.z, v2.z), std::min(v1.w, v2.w));
}

template<typename T>
inline Vector4<T> maximum(const Vector4<T>& v1, const Vector4<T>& v2) noexcept
{
...
struct Vector4<float>
{
	...
	Vector2<float> xy/*getXY*/() const noexcept { return Vector2<float>(simd::swizzle4<simd::XYYY>(xyzw)); }
	Vector3<float> xyz/*getXYZ*/() const noexcept { return Vector3<float>(simd::swizzle4<simd::XYZZ>(xyzw)); }
#else
...
template<>
inline Vector4<float> minimum(const Vector4<float>& v1, const Vector4<float>& v2) noexcept
{
	return Vector4<float>(simd::min4(v1, v2));
}

template<>
inline Vector4<float> maximum(const Vector4<float>& v1, const Vector4<float>& v2) noexcept
{
