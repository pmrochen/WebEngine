...
#endif
	Color3& operator/=(const float f) noexcept { rgb = float4::div4(rgb, float4::set4(f)); return *this; }
...
#endif
	friend Color3 operator/(ConstArg c, const float f) noexcept { return Color3(float4::div4(c, float4::set4(f))); }
