...
struct Tuple2x2
{
	...
	constexpr Tuple2x2(const T m00, const T m01, const T m10, const T m11) noexcept : m00(m00), m01(m01), m10(m10), m11(m11) {}
	constexpr Tuple2x2(const Tuple2<T>& row0, const Tuple2<T>& row1) noexcept : m00(row0.x), m01(row0.y), m10(row1.x), m11(row1.y) {}
	explicit Tuple2x2(const T* const m) noexcept : m00(m[0]), m01(m[1]), m10(m[2]), m11(m[3]) {}

	explicit operator T*() noexcept { return &m00; }
	explicit operator const T*() const noexcept { return &m00; }
	Tuple2<T>& operator[](const int i) noexcept { return reinterpret_cast<Tuple2<T>*>(&m00)[i]; }
	const Tuple2<T>& operator[](const int i) const noexcept { return reinterpret_cast<const Tuple2<T>*>(&m00)[i]; }
...
struct Tuple3x3
{
	...
	constexpr Tuple3x3(const T m00, const T m01, const T m02, const T m10, const T m11, const T m12, const T m20, const T m21, const T m22) noexcept :
	...
	explicit Tuple3x3(const T* const m) noexcept : m00(m[0]), m01(m[1]), m02(m[2]), m10(m[3]), m11(m[4]), m12(m[5]), m20(m[6]), m21(m[7]),
		m22(m[8]) {}

	explicit operator T*() noexcept { return &m00; }
	explicit operator const T*() const noexcept { return &m00; }
	Tuple3<T>& operator[](const int i) noexcept { return reinterpret_cast<Tuple3<T>*>(&m00)[i]; }
	const Tuple3<T>& operator[](const int i) const noexcept { return reinterpret_cast<const Tuple3<T>*>(&m00)[i]; }
...
struct Tuple4x3
{
	...
	constexpr Tuple4x3(const T m00, const T m01, const T m02, const T m10, const T m11, const T m12, const T m20, const T m21, const T m22,
		const T m30, const T m31, const T m32) noexcept : m00(m00), m01(m01), m02(m02), m10(m10), m11(m11), m12(m12), m20(m20), m21(m21), m22(m22),
	...
	explicit Tuple4x3(const T* const m) noexcept : m00(m[0]), m01(m[1]), m02(m[2]), m10(m[3]), m11(m[4]), m12(m[5]), m20(m[6]), m21(m[7]),
...
struct Tuple4x4
{
	...
	constexpr Tuple4x4(const T m00, const T m01, const T m02, const T m03, const T m10, const T m11, const T m12, const T m13, const T m20, const T m21,
		const T m22, const T m23, const T m30, const T m31, const T m32, const T m33) noexcept : m00(m00), m01(m01), m02(m02), m03(m03), m10(m10), m11(m11),
	...
	explicit Tuple4x4(const T* const m) noexcept : m00(m[0]), m01(m[1]), m02(m[2]), m03(m[3]), m10(m[4]), m11(m[5]), m12(m[6]), m13(m[7]),
		m20(m[8]), m21(m[9]), m22(m[10]), m23(m[11]), m30(m[12]), m31(m[13]), m32(m[14]), m33(m[15]) {}

	explicit operator T*() noexcept { return &m00; }
	explicit operator const T*() const noexcept { return &m00; }
	Tuple4<T>& operator[](const int i) noexcept { return reinterpret_cast<Tuple4<T>*>(&m00)[i]; }
	const Tuple4<T>& operator[](const int i) const noexcept { return reinterpret_cast<const Tuple4<T>*>(&m00)[i]; }
