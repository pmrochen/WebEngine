/*
 *  Name: Half
 *  Authors: Ladislav Lang, Joannes Vermorel
...
namespace Foundation.Mathematics
{
	...
	public readonly struct Half : IComparable, IFormattable, IConvertible, IComparable<Half>, IEquatable<Half>
	{
		...
		/// <summary>
		/// Initializes a new instance of System.Half to the value of its binary representation.
		/// </summary>
		/// <param name="value">A 16-bit unsigned integer that contain the binary representation of value.</param>
		/// <param name="bits">Unused.</param>
		private Half(ushort value, bool bits) { Value = value; }
		#endregion
		...
		/// <summary>
		/// Converts the binary representation of System.Half to its value.
		/// </summary>
		/// <param name="value">A 16-bit unsigned integer that contain the binary representation of value.</param>
		/// <returns>A System.Half value.</returns>        
		public static Half FromBits(ushort value)
		{
			return new Half(value, true);
		}
		...
		{
			return new Half(bits, true); //return new Half { Value = bits };
		}
