...
namespace Foundation.Mathematics
{
	public class RationalConverter : TypeConverter
	{
		...
		{
			return new StandardValuesCollection(new object[2] { Rational.Zero, Rational.One });
		}
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object obj)
		{
			...
			if (str != null) 
				return (str.Length > 0) ? Rational.Parse(str, culture) : Rational.Zero;
		...
		{
			if (type == typeof(string))
				return ((Rational)obj).ToString(culture);
